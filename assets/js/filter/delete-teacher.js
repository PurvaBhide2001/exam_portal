...
const deleteTeacher = ((id) => {
    ...
    setTimeout(() => {
        ...
        teacherApi.delete(id).then(({ status, data, message }) => {
            ...
            if (status == 200) {
                ...
                teacherTable.row(deleteRow).remove().draw()
...
const openDeleteModal = ((element, id) => {
    ...
    $(".delete-element").text("Teacher")
    $("#delete-btn").attr("onclick", `deleteTeacher(${id})`)
