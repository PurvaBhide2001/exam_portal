...
<body>
            ...
            <div class="d-flex justify-content-end">
              <nav aria-label="breadcrumb text-end">
                <ol class="breadcrumb breadcrumb-style1">
                  ...
                  <li class="breadcrumb-item">
                    <a href="./list-studentss.php">Students</a>
                  </li>
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body mt-2">
                    <div class="row pt-3">
                      ...
                      <div class="col-md-4 mb-3 form-group">
                        <label for="" class="form-label">Admission Date<sup class="text-danger">*</sup></label>
                        <input type="date" name="admission_date" class="form-control" id="admission_date" placeholder="Admission Date" >
                      </div>
                      <div class="col-md-4 mb-3 form-group">
                        <label for="" class="form-label">Blood Group<sup class="text-danger">*</sup></label>
  ...
  <script src="./assets/js/filter/edit-student.js"></script>
</body>
